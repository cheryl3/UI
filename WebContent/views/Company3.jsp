...
<title>Companies|Company3</title>
		...
		<div class="main-content-inner">
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<ul class="breadcrumb">
					...
					<li class="active">Morgan Stanley</li>
				</ul>
				<!-- /.breadcrumb -->
											...
											<div class="row">
												<div class="col-xs-12 col-sm-3 center">
													<span class="profile-picture"> <img
														...
														id="avatar2" src="assets/images/companies/morganstanley.jpg" />
													</span>
														...
														<div class="widget-body">
															<div class="widget-main">
																...
																<div class="profile-info-row">
																	...
																	<div class="profile-info-value">
																		<span>Morgan Stanley, Athena, Bldg. No. 5, Sector 30, Mindspace, Goregaon West, Mumbai, Maharashtra 400090</span>
																	</div>
																</div> 
																	<div class="hr hr-8 dotted"></div>
																<a href="http://www.morganstanley.com/" class="btn btn-sm btn-block btn-primary"> <i
