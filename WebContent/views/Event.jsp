...
<![endif]-->
	...
	<script type="text/javascript">
		...
		grid_data.push({
			...
			ctc : "6 lakhs",
			skillsrequired : "Java" ,
			docsrequired : "University Marksheet"
		})
		grid_data.push({
			jobdescription : "Tester",
			jobcategory : "NonDream",
			ctc : "3 lakhs",
			skillsrequired : "Java Junit Testing" ,
			docsrequired : "University Marksheet,Certificates"
		})
		
		grid_data.push({
			jobdescription : "UI Developer",
			jobcategory : "NonDream",
			ctc : "3.5 lakhs",
			skillsrequired : "Angular,css,javascript" ,
			docsrequired : "University Marksheet"
		})
		grid_data.push({
			jobdescription : "Developer",
		...
		jQuery(function($) {
			...
			jQuery(grid_selector).jqGrid({
				...
				height : 125,
				width : 10,
				colNames : [ 'Job Description', 'Job Category' , 'CTC', 'Skills Required', 'Documents Required' ],
				colModel : [
