												...
												<%-- <div id="profile" class="tab-pane in active">
													<div class="row">
														...
														<div class="profile-info-row">
															<div class="profile-info-name">Current Account
																Status:</div>
														...
														<div class="profile-info-row">
															<div class="profile-info-name">Date Joined/Created:
															</div>
												...
												<div class="widget-box">
													...
													<div class="widget-body">
														<div class="widget-main padding-4 scrollable"
															...
															<p class="alert alert-info">TCS Mock Interviews..</p>
															<p class="alert alert-danger">TCS Pre-placement
																talk..</p>
															<p class="alert alert-success">
																Jp Morgan CODE FOR GOOD Registration.
																<t>25th march 2016</t>
															</p>
															<p class="alert alert-primary">
																Aptitude test for all BE student.
																<t></t>
																22nd may 2016
															</p>
