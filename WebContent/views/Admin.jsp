...
<body>
 ...
 -->
										...
										<li><a data-toggle="tab" href="#manageuser"> <i
												class="pink ace-icon fa fa-picture-o bigger-120"></i> Manage
												Users
										</a></li>

										<li><a data-toggle="tab" href="#upload"> <i
												class="blue ace-icon fa fa-users bigger-120"></i> File
												Upload
										</a></li>
									</ul>
									...
									<div class="tab-content no-border padding-24">
										...
										<div id="manageuser" class="tab-pane">
											<div class="row">
														...
														<div class="panel panel-inverse active">
															...
															<div class="panel-collapse collapse in" id="collapseOne">
																<div class="panel-body">
																	<form class="form-inline" method="POST" action="/UploadProj/SubmitAssignTPO">


																		<div>
																			<input type="text" id="form-field-1"
																				placeholder=" Name of TPO"
																				class="col-xs-10 col-sm-10" name="username" />
												...
												<div class="col-xs-12 col-sm-6 right">
													<div id="accordion" class="accordion-style1 panel-group">
														<div class="panel panel-inverse active">
															...
															<div class="panel-collapse collapse in" id="collapseOne">
																<div class="panel-body">
																	<form class="form-inline" method="POST" action="/UploadProj/SubmitRemoveTPO">
												...
												<div class="col-med-6 col-xs-6 col-sm-6 left">
													<jsp:directive.include file="viewUser.jsp"/>
												</div>
													...
													<div class="widget-body">
														<div class="widget-main">
															<div class="form-group">
																<div class="col-xs-10">
																	<input type="file" id="id-input-file-2" multiple />
																</div>
																<button class="btn btn-sm btn-yellow" type="submit">Upload</button>
																<!-- <button  class="btn btn-sm btn-yellow"  type="reset" >reset</button> -->

															</div>

															<h4 align="center">OR</h4>
															<a href="#" id="hideShow"><p align="center">Add
																	Users Manually</p></a>
															<div id="messeage" style="display: none;">
																<input type="text" id="form-field-1"
																	placeholder=" Name of user" class="col-xs-10 col-sm-8" /><br>
																<br> <input type="text" id="form-field-1"
																	placeholder=" eg. StudentTPC, FacultyTPC etc.."
						...
						.fullCalendar(
								{
									...
									events : [
											...
											{
												title : 'Long Event',
												start : moment().subtract(5,
														'days').format(
														'YYYY-MM-DD'),
												end : moment().subtract(1,
														'days').format(
														'YYYY-MM-DD'),
