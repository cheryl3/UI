...
public class FileUploadController {
	...
	private String saveDirectory = "C:/data/";
																				// folder
																				// where
																				// the
																				// file
	...
	public String handleFileUpload(HttpServletRequest request, @RequestParam CommonsMultipartFile fileUpload)
		...
		if (!fileUpload.isEmpty()) {
			...
			System.out.println("Saving file: " + fileUpload.getOriginalFilename()+ " to "+saveDirectory);
	...
	public String handleMultipleFileUpload(HttpServletRequest request, @RequestParam CommonsMultipartFile[] fileUpload)
			throws Exception {
		...
		if (fileUpload != null && fileUpload.length > 0) {
			...
			for (CommonsMultipartFile aFile : fileUpload) {
				...
				System.out.println("Saving file: " + aFile.getOriginalFilename()+ " to "+saveDirectory);
